...
import { ArrowRight, Calendar, BookOpen, Video, Download, Clock, Users, Star, Search } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {filteredBlogPosts.filter(post => post.featured).length > 0 ? (
                filteredBlogPosts.filter(post => post.featured).map((post, index) => (
                ...
                <p className="text-muted-foreground text-center col-span-full">No hay artículos destacados que coincidan con tu búsqueda.</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredBlogPosts.filter(post => !post.featured).length > 0 ? (
                ...
                <p className="text-muted-foreground text-center col-span-full">No hay más artículos que coincidan con tu búsqueda.</p>
              )}
            </div>
          </div>
